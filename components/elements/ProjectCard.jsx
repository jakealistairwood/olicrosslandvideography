    ...
    return (
        ...
        >
            ...
            >
                <div className="aspect-[16/9] relative w-full">
                    <Image 
                        className={`${hovered ? "opacity-80" : "opacity-100"} transition-opacity duration-200 ease w-full h-full object-cover`} 
                        src={urlForImage(featured_image?.asset)} 
                        alt={featured_image?.alt_text || ""} 
                        fill 
                    />
                    <motion.div 
                        className="origin-center will-change-transform absolute top-6 right-6 w-[36px] h-[36px] bg-accent text-white flex items-center justify-center rounded-full" 
