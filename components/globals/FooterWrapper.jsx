                        ...
                        {linkExists && (
                            <div className="w-fit">
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-center rounded border border-[#4D4D4D] min-h-[54px] py-4 px-6 relative overflow-hidden">
                                        <motion.div className="relative z-[2]" variants={ctaLabelAnimation} initial="initial" animate={hovered ? "animate" : "initial"} >
    ...
    return (
        <nav>
            ...
            <menu className="mt-10 font-mono flex flex-col text-sm gap-y-6">
                <li>
                    <Link href="/" className="uppercase tracking-[0.04em] duration-300 ease transition-colors text-white-80 hover:text-white">Home</Link>
                </li>
                <li>
                    <Link href="/about" className="uppercase tracking-[0.04em] duration-300 ease transition-colors text-white-80 hover:text-white">About</Link>
                </li>
                <li>
...
const ContactLinksCol = ({ mobile, email }) => {
    return (
        <nav>
            ...
            <menu className="mt-10 font-mono flex flex-col text-sm gap-y-6">
                <li>
                    <Link href={`mailto:${email}` || ""} className="flex items-center gap-x-4 uppercase tracking-[0.04em] duration-300 ease transition-colors text-white-80 hover:text-white">
                        <div className="">
                ...
                <li>
                    <Link href={`tel:${mobile}` || ""} className="flex items-center gap-x-4 uppercase tracking-[0.04em] duration-300 ease transition-colors text-white-80 hover:text-white">
                        <div className="">
