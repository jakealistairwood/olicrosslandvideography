        ...
        <header>
            <div className="container">
                <div className="flex flex-col">
                    <h1 className="font-heading ~text-[4rem]/[7.875rem] uppercase tracking-[0.04em] text-ice font-medium pt-20">My Portfolio</h1>
                    {categories && categories.length > 0 && (
                        <div className="flex items-center gap-x-4 lg:gap-x-8 w-full flex-wrap font-light font-heading text-lg lg:text-2xl uppercase tracking-[0.13em]">
